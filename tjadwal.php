                              ...
                              <tr>
                                <form method="post">
                                  ...
                                  <td class="d-flex">
                                      ...
                                      <a href="jadwal-config.php?Aksi=Hapus&id=' . $DATA['id_jadwal'] . '" class="btn btn-danger">Hapus</a>
                                  </td>
                                  </form>
                               </tr>
                              ';
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" style="color: black;">Tambah Jadwal Kursus</h5>
