                              ...
                              <tr>
                                <form method="post">
                                  ...
                                  <td class="d-flex">
                                      ...
                                      <a href="pelajar-config.php?Aksi=Hapus&id=' . $DATA['id_pelajar'] . '" class="btn btn-danger">Hapus</a>
                                  </td>
                                  </form>
                               </tr>
                              ';
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" style="color: black;">Tambah Pelajar</h5>
