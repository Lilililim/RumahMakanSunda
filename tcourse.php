...
<body class="h-100 text-center bg-anime">
  ...
  <div class="d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <div class="container-lg mt-5 text-left text-white">
      ...
      <div>
        <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#courseModal">Tambah Kursus</button>
      </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel" style="color: black;">Tambah Kursus</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <form method="post" enctype="multipart/form-data">
                <label for="Pelatihan" class="mt-2" style="color: black;">Masukkan nama pelatihan: </label>
                <input type="text" id="Pelatihan" name="Pelatihan" class="form-control">
                <label for="Keterangan" class="mt-2" style="color: black;">Masukkan keterangan pelatihan: </label>
                <input type="text" id="Keterangan" name="Keterangan" class="form-control">
                <label for="Lama" class="mt-2" style="color: black;">Masukkan lama waktu pelatihan: </label>
